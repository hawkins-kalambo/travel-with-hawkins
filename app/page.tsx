...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-[#101815]">
      ...
      <footer id="contact" className="bg-[#0a2d56] px-4 py-10 text-white">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-5">
            ...
            <div>
              <h3 className="mb-3 font-black uppercase">Direct Contact</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-start gap-3">
                  <a
                    ...
                    className="grid h-11 w-11 place-items-center rounded-full bg-white/10 ring-1 ring-white/20 transition-transform hover:scale-105 hover:bg-white/15"
                    aria-label="WhatsApp +265989127308"
                  >
                    <Image src="/icons/whatsapp.png" width={22} height={22} alt="" />
                  </a>
                  <div>
                    <a href="https://wa.me/265989127308" target="_blank" rel="noopener noreferrer" className="font-semibold text-white hover:underline">WhatsApp</a>
                    <div className="text-xs text-white/75">0989127308</div>
                  </div>
                </div>

                <div>
                  <a href="mailto:smoothridemw@gmail.com" className="transition-colors hover:text-white hover:underline">smoothridemw@gmail.com</a>
                </div>

                <div>
                  <a href="tel:+265886470843" className="transition-colors hover:text-white hover:underline">0886470843</a>
                </div>
              </div>
            </div>
          </div>
